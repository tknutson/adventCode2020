    ...
    public class Program
    {
        public static void Main()
        {
            ...
            for (var i = 0; i < expenseArray.Length; i++)
            {
                ...
                {
                    int sum = Convert.ToInt32(expenseArray[i]) + Convert.ToInt32(expenseArray[(a)]);
                    ...
                    {
                        if (Equals2020(sum, Convert.ToInt32(expenseArray[(b)])))
                        {
        ...
        private static bool Equals2020(int a, int b)
        {
            return a + b == 2020;
        }
    }
